...
auth-lab/
  ...
  tools/
    policy-audit.py         Programmatic audit of GitOps/FabricBot
                            ...
                            repos. Flags rules that gate auto-approve or
                            enable-auto-merge actions on User-type GitHub
                            accounts (namespace-reclamation surface). Found
                            3 rules in 3 repos: dotnet/aspnetcore,
                            dotnet/efcore, dotnet/roslyn.
```
